...
[NASA Earthdata STAC Catalogs](https://radiantearth.github.io/stac-browser/#/external/cmr.earthdata.nasa.gov/stac/)
...
```{r}
bbox <- c(xmin=-123, ymin=37.25, xmax=-122, ymax=38.25) 
start <- "2021-12-01"
end <- "2021-12-31"
